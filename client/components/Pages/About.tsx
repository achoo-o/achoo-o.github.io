  ...
  return (
    <section className="flex flex-col items-center gap-5 mt-44 p-2">
      ...
      <section className="max-w-screen-md text-xl text-gray-200 text-center leading-loose">
        ...
        <a href="https://github.com/achoo-o/" target="_blank" rel="noreferrer">
          <span className="mt-16 [&>svg]:h-8 [&>svg]:w-8 mb-2 inline-block rounded-full bg-opacity-0 border p-3 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
            <svg
